...
inline bool isBad(int val){
    return binary_search(b, b+m, val);
}
inline int getBad(int val, int num){
    if (isBad(val)) return -num;
    else return num;
}
int calcVal(int n){
